...
<!-- Mirrored from www.themenate.net/enlink-bs/dist/index-crm.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 05 Dec 2021 04:49:46 GMT -->
<head>
    <meta charset="utf-8">
                                ...
                                <div class="p-h-20 p-b-15 m-b-10 border-bottom">
                                    <div class="d-flex m-r-50">
                                        ...
                                        <div class="m-l-10">
                                            ...
                                            <p class="m-b-0 opacity-07">{{ Auth::user()->is_admin }}</p>
                                        </div>
                                    </div>
                                </div>
                                <a href="/brand/profil/{{ Auth::user()->id }}" class="dropdown-item d-block p-h-15 p-v-10">
                ...
                <div class="side-nav-inner">
                    <ul class="side-nav-menu scrollable">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li>
                                    <a href="avatar.html">Produk Masuk </a>
                                </li>
                                <li>
                                    <a href="alert.html">Produk Terjual</a>
                                </li>
                                <li>
                                    <a href="badge.html">Transaksi</a>
                                </li>
                            </ul>
                    </ul>
                </div>
            ...
            @yield('content')
                ...
                <footer class="footer">
                    <div class="footer-content">
                        <p class="m-b-0">Copyright © 2021 PECIKUID.</p>
                    </div>
                </footer>
                <!-- Footer END -->
...
<!-- Mirrored from www.themenate.net/enlink-bs/dist/index-crm.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 05 Dec 2021 04:49:57 GMT -->
</html>